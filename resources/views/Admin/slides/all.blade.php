@extends('Admin.admin')
@section('title')
    <title> داشبورد مدیریتی  / مدیریت اسلایدها  </title>
@endsection
@section('main')
@section('menu')
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6 col-6">
                                                            <div class="btn-group pull-right">
                                                                <a href="{{url('admin/slides/create')}}" id="addRow" class="btn btn-info">
                                                                    افزود نمونه کار جدید <i class="fa fa-plus"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="table-scrollable">
                                                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td class="left">{{$slide->description}}</td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('slides.edit' , $slide->id) }}"  class="btn btn-primary btn-xs">
