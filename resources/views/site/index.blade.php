            ...
            <div class="row text">
                <div class="col-lg-6 col-md-12 col-sm-12 col-sx-12">
                    <div class="about__pic">
                        <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/about-pic.jpg')}}" title="سنگبری شایان دهبید عظیمی"  alt="سنگبری شایان دهبید عظیمی">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="services__item">
                        <div class="services__item__pic">
                            <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/stone1.jpg')}}" title="سنگ دهبید شایان عظیمی" alt="سنگ دهبید شایان عظیمی">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="services__item services__item__top">
                        ...
                        <div class="services__item__pic">
                            <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/stone2.jpg')}}" title="سنگ امپرادور دارک اسپانیا" alt="سنگ امپرادور دارک اسپانیا">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="services__item">
                        <div class="services__item__pic">
                            <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/stone3.jpg')}}" title="سنگ چینی ازنا" alt="سنگ چینی ازنا">
                        </div>
                        <div class="services__item__text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="services__item services__item__top">
                        ...
                        <div class="services__item__pic">
                            <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/stone4.jpg')}}" title="سنگ لته ترکیه" alt="سنگ لته ترکیه">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div>
                        <img src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/callto-text-bg.jpg')}}" style="width: 100%;height: 500px;" title="کارخانه سنگبری پارسیان دهبید عظیمی" alt="کارخانه سنگبری پارسیان دهبید عظیمی">
                ...
                <div class="col-lg-6 p-0">
                    <div>
                        <img  src="{{asset('images/loadimage.png')}}" class="lazy" data-src="{{asset('images/callto-quote-bg.jpg')}}" style="width: 100%;height: 500px;" title="کارخانه سنگبری پارسیان دهبید عظیمی" alt="کارخانه سنگبری پارسیان دهبید عظیمی">
                        <div  style="position:absolute;line-height: 10px;margin: -256px 10% 0px 35%;">
