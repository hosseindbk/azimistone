                        ...
                        <div class="product__item">
                            <a href="{{url('محصولات'.'/'.$product->slug)}}">
                                <div class="product__item__pic">
                                    <img src="{{asset('images/loadimage.png')}}" data-src="{{asset($product->images)}}" class="lazy"  style="max-height: 338px;width: -webkit-fill-available;" title="{{$product->title}}" alt="{{$product->title}}">
                                </div>
                            </a>
